...
<head>
	...
	function empList(){
		...
		var url = "${pageContext.request.contextPath}/restful/list.json"
		...
		$.ajax({
	        ...
	        success: function(result) {
	        	...
	        	$(result).each(function(){
	        		...
	        		var imgUrl = Math.floor((Math.random() * 6) + 1);
					...
					html += '<img src="images/home/product' + imgUrl + '.jpg" alt="" />';			
					html += '<h2>' + this.sal + '</h2>';
					html += '<p>' + this.ename + '</p>';
	        	...
	        	$("#empfeature").append(html); 
	        	console.log(html);

	
	        } //end function(resuslt)
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items" id="empfeature"><!--features_items=========================-->
